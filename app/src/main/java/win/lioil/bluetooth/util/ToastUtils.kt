...
object ToastUtils {
    ...
    fun setToastTextSize() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.R){
            mToast = Toast.makeText(MyApplication.instance.applicationContext, null, Toast.LENGTH_SHORT)
    ...
    fun showLong(text: String) {
        if (mToast == null){
            mToast = Toast.makeText(MyApplication.instance.applicationContext, null, Toast.LENGTH_LONG)
        }
